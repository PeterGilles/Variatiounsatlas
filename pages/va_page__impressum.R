...
# News Page
va_page__impressum <- page_fluid(
    tags$head(
        tags$meta(name="viewport", content="width=device-width, initial-scale=1.0"),
        tags$script(src = "js/menu_show.js")
    
    ),
    title = "Variatiounsatlas | Impressum | uni.lu",
    ...
    unilu_navbar(
            ...
            unilu_navpage("Impressum", href = route_link("impressum"), is_active = TRUE),
    ...
    div(class = "row",
        div(class = "col-xl-6 text-start",
            unilu_title_small(i18n$t("Impressum & Merci")),
            unilu_text_md("content/outro.md"),      
            unilu_button(i18n$t("Kaarten"), route_link("kaarten"))     
        )
    ),
