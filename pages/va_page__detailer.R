...
# News Page
va_page__detailer <- page_fluid(
    tags$head(
        tags$meta(name="viewport", content="width=device-width, initial-scale=1.0"),
        tags$script(src = "js/menu_show.js")

    ),
    title = "Variatiounsatlas | Detailer | uni.lu",
    ...
    unilu_navbar(
            ...
            unilu_navpage("Detailer", href = route_link("detailer"), is_active = TRUE),
    ...
    div(class = "row",
        div(class = "col-xl-6 text-start",
            unilu_title_small("Detailer"),
            unilu_text_md("content/detailer.md"),      
