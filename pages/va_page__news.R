...
# News Page
va_page__news <- page_fluid(
    tags$head(
        tags$meta(name="viewport", content="width=device-width, initial-scale=1.0"),
        tags$script(src = "js/menu_show.js")

    ),
    title = "Variatiounsatlas | News | uni.lu",
    ...
    unilu_navbar(
            ...
            unilu_navpage("News", href = route_link("news"), is_active = TRUE),
    ...
    div(class = "row",
        div(class = "col-xl-6 text-start",
            unilu_title_small("News & Updates"),
            unilu_text_md("content/news.md"),      
